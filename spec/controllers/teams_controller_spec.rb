...
RSpec.describe TeamsController, type: :controller do
  #parte obrigatória para devise e setar um usuário válido e logado
  ...
  describe "GET #index" do
    it "returns http success" do #quando tiver a diretiva it, quer dizer "vai gerar algo", nesse caso, success
      get :index
